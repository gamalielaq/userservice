...
public class UserserviceApplication {
	...
	@Bean
	PasswordEncoder passwordEncoder() { //Cada vez que se ejecute la aplicación tendremos disponible este bean
	...
	CommandLineRunner run(UserService userService) {
		return args -> {
			...
			userService.saveUser(new User(null, "Arnold Test", "arnold", "1234", new ArrayList<>()));
